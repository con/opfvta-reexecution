...
\def \codeURL{https://github.com/con/opfvta-replication-2023}
\def \codeDOI{}
\def \dataURL{}
\def \dataDOI{}
\def \editorNAME{}
...
\def \reviewURL{}
\def \articleABSTRACT{
!!!Three years have passed since ReScience published its first article and since September 2015, things have been going steadily.
We're still alive, independent and without a budget.
...
Based on our experience at managing the journal during these three years, we think the time is ripe for proposing some changes.
}
\def \replicationCITE{}
\def \replicationBIB{}
\def \replicationURL{}
