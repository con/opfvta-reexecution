...
\begin{figure}
	\centering
	\begin{subfigure}
		\includegraphics[clip,width=0.48\textwidth]{figs/diff_date}
		\caption{
			Subcaption 1
		}
		\label{fig:diff_date}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[clip,width=0.48\textwidth]{figs/diff_text}
		\caption{
			Subcaption 2
		}
		\label{fig:diff_text}
	\end{subfigure}
	\begin{subfigure}
		\includegraphics[clip,width=0.48\textwidth]{figs/diff_fig}
		\caption{
			Subcaption 3
		}
		\label{fig:diff_fig}
