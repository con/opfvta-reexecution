...
\begin{figure*}
	...
	\caption{
		\textbf{Page-wise pixel differences between the Historical Manuscript Record and new reexecution system outputs visualize overall reproduction fidelity, and highlight pages with noteworthy differences.}
